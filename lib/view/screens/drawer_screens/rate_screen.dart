      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              AppLocalizations.of(context)!.rateQuestion,
                ...
                return Padding(
                  ...
                  child: CustomIconButton(
                    ...
                    onPressed: () {
                      CustomSnackBar.show(
                        context,
                        '${AppLocalizations.of(context)!.thanksForRating}! (${i + 1} ★)',
                      );
                    },
                  ),
                );
            ...
            FilledButton(
              onPressed: () {
                CustomSnackBar.show(context, AppLocalizations.of(context)!.thanksForRating);
              },

class TermsConditionsApiModel {
  const TermsConditionsApiModel({
    this.id,
    this.title,
    this.content,
    this.slug,
  ...
  factory TermsConditionsApiModel.fromJson(Map<String, dynamic> json) {
    return TermsConditionsApiModel(

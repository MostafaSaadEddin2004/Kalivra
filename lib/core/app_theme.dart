...
class AppTheme {
  ...
  static ThemeData get light => ThemeData(
    ...
    colorScheme: ColorScheme.light(
      ...
      secondaryFixed: AppColors.offWhite,
      tertiaryFixed: AppColors.burgundy.withValues(alpha: 0.12),
      ...
      onSecondaryFixedVariant: AppColors.taupe,
  ...
  static ThemeData get dark => ThemeData(
    ...
    colorScheme: ColorScheme.dark(
      ...
      tertiaryFixed: AppColors.taupe.withValues(alpha: 0.4),
      ...
      onSecondaryFixedVariant: AppColors.burgundy,
      onError: AppColors.red,

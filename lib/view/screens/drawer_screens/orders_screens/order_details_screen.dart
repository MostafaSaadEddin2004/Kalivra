...
class OrderDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: DrawerScreenAppBar(title: l10n.orderDetails),
      body: ListView(
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4.h),
              Text(
                '$qty × ${unitPrice.toStringAsFixed(0)} ${AppLocalizations.of(context)!.currencySYP}',
        ...
        Text(
          '${total.toStringAsFixed(0)} ${AppLocalizations.of(context)!.currencySYP}',
          style: theme.textTheme.titleMedium?.copyWith(
            color: isDark ? AppColors.goldLight : AppColors.burgundy,
            fontWeight: FontWeight.w700,
          ),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  '${total.toStringAsFixed(0)} ${l10n.currencySYP}',
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        Text(
          '${value.toStringAsFixed(0)} ${AppLocalizations.of(context)!.currencySYP}',
          style: theme.textTheme.bodyLarge?.copyWith(
            color: isDark ? AppColors.offWhite : AppColors.black,
